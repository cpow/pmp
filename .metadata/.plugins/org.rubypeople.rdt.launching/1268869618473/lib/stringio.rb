...
-----------------
     ...
     closed_write?, content_type, each, each_byte, each_line, eof, eof?,
     fcntl, fileno, flush, fsync, getc, gets, isatty, length, lineno,
     lineno=, original_filename, path, pid, pos, pos=, print, printf,
     putc, puts, read, readchar, readline, readlines, reopen, rewind,
     seek, size, string, string=, sync, sync=, sysread, syswrite, tell,
     truncate, tty?, ungetc, write
